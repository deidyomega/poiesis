...
class ThemeColors(BaseModel):
    """Color palette for the Poiesis UI theme."""
    bg: str = "#0f0f0f"
    surface: str = "#1a1a1a"
    border: str = "#2a2a2a"
    accent: str = "#6366f1"
...
PRESET_THEMES: dict[str, PoiesisTheme] = {
    "default": PoiesisTheme(),
    "pink_gothic": PoiesisTheme(
        name="pink_gothic",
