...
Salvaged in spirit from the old ouroboros/sandbox.py git helpers, trimmed to
what the supervisor and the request_deploy tool need. No AST/import blocklist.
"""
